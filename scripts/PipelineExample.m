...
fname_test = [pwd '/ProcessedData/' PMLType '/EvaluationDataset_Sub' int2str(subsampling_test) '.mat'];
...
save([pwd '/ProcessedData/' PMLType '/TrainDataReducedByPCA' int2str(pca_ratio*100) '_Sub' int2str(subsampling_train) '.mat'], 'dataset_training');
save([pwd '/ProcessedData/' PMLType '/EvaluationReducedPCA' int2str(pca_ratio*100) '_Sub' int2str(subsampling_train) '.mat'], 'dataset_test');
